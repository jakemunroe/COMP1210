...
public abstract class MarketingCampaign implements 
   ...
   /**
    *Compares two MarketingCampaign objects lexicographically based on their
    *names.
    *
    *@param objIn Object that will be compared to.
    *@return An int value representing the lexicographic comparison.
    */
   public int compareTo(MarketingCampaign objIn) {
     //using String compareTo to compare our two objects
