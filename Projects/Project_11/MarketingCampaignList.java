...
public class MarketingCampaignList {
   ...
   /**
    *Method used to read in a given file and handles possible
    *InvalidCategoryException, NoSuchElementException,
         ...
         try {
            ...
            switch (category) {
               ...
               default: //for invalid category codes
                  InvalidCategoryException except =
                     new InvalidCategoryException("" + category);
                  info += "\n" + except.toString();
            ...
            error = new NoSuchElementException("For missing input data");
            info += "\n" + error.toString();
            this.addInvalidRecord(info);
         }
      } while (input.hasNext());
   ...
   /**
    *Takes the invalid data array and creates a string report of the invalid
    *data with their exceptions.
    *
    *@return The report of the invalid data.
    */
